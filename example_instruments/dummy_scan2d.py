...
class dummy_scan2d(CyclopeanInstrument):
    def __init__(self, name, address=None):
        ...
        self.set_xstart(-10.0)
        self.set_xstop(10.0)
        self.set_ystart(-10.0)
        self.set_ystop(10.0)
        self.set_xsteps(11)
        self.set_ysteps(11)
        ...
        import qt
        self._ins_linescan = qt.instruments['dummy_linescan']
    ...
    def _fetch_line(self):
        ...
        x0 = self._x[0]
        self._ins_linescan.set_start((x0, y0))
