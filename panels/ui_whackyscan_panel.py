...
class Ui_Panel(object):
    def setupUi(self, Panel):
        ...
        self.xcut_plot.setFrameShape(QtGui.QFrame.StyledPanel)
        self.xcut_plot.setFrameShadow(QtGui.QFrame.Raised)
        ...
        self.xycut_plot.setFrameShape(QtGui.QFrame.StyledPanel)
        self.xycut_plot.setFrameShadow(QtGui.QFrame.Raised)
